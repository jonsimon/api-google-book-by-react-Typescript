...
context('Search for Books', () => {
    ...
    it('Search', () => {
      ...
      const item = {
        ...
        "volumeInfo": {
          ...
          "imageLinks": {
            ...
            "thumbnail": "http://localhost:3000/images/content.jpeg"
          },
          "language": "en",
          "previewLink": "http://books.google.com/books?id=eq9XvgAACAAJ&dq=HarryPotte&hl=&cd=1&source=gbs_api",
          "infoLink": "http://books.google.com/books?id=eq9XvgAACAAJ&dq=HarryPotte&hl=&source=gbs_api",
      ...
      const response = {
       ...
       cy.intercept('GET','https://www.googleapis.com/books/v1/volumes?q=HarryPotte',response).as('Get Books');
